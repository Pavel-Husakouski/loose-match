...
describe('array', () => {
  it('array with single element (all cases)', () => {
  ...
  it('array with multiple fixed elements (all cases)', () => {
  ...
  it('array with non-array input (all cases)', () => {
    const schema = array(['test']);
  ...
  it('array error positioning at different indices (all cases)', () => {
